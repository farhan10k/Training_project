...
public static WebDriver driver;
  ...
  public void beforeClass(String wbsite, String br) {
	  if(br.equalsIgnoreCase("chrome")) {
			 System.setProperty("webdriver.chrome.driver", "C:\\Users\\Faisal\\eclipse-workspace\\training\\Drivers\\chromedriver.exe"); 
		  driver=new ChromeDriver();
		  driver.navigate().to(wbsite);
		 
	  }else if(br.equalsIgnoreCase("firefox")) {
		  System.setProperty("webdriver.gecko.driver", "C:\\Users\\Faisal\\Downloads\\geckodriver-v0.26.0-win64\\geckodriver.exe");
